...
$(document).ready(function () {
    ...
    $('#TrainingNeedAssessmentRequestId').change(function () {
        //console.log('need assement change');
    ...
    if (requestId > 0) {
        ...
        fillDataForNeedAssment();
    }
    $('#PerformSince').change(function () {
       // console.log('PerformSince');
    });
...
function chaneTrainingCourses() {
   // console.log('chaneTrainingCourses');
}
...
function changeTrainingNeedAssement() {
    var requestId = $('#TrainingNeedAssessmentRequestId').val();
    if (requestId > 0) {
        $("#sectionQuestion").empty();
        fillDataForNeedAssment();
    }
}

function fillDataForNeedAssment() {
    var requestId = $('#TrainingNeedAssessmentRequestId').val();
    $.ajax({
        type: "POST",
        ...
        success: function (response) {
         //   console.log(response);
          ...
          //  console.log('before courseIds');
            setTitleExam();
           // console.log('after courseIds');
