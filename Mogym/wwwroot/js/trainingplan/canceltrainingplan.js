...
$(document).ready(function () {
    ...
    $('#form-tms').submit(function (event) {
        ...
        var messageHasClassNoSession = 'برای این برنامه ریزی کلاس تعیین شده است آیا از منتفی کردن مطمئن هستید!';
        var messageNoClass = 'آیا از منتفی کردن این برنامه آموزشی مطمئن هستید؟';
        ...
        if (currentStatus == statusNoClass || currentStatus == statusHasClassNoSession) {
            Swal.fire({
                ...
                confirmButtonText: 'ادامه عملیات و منتفی',
