...
var FullCalendar = (function (exports) {
    ...
    */
    ...
    function organizeRawLocales(explicitRawLocales) {
        var defaultCode = explicitRawLocales.length > 0 ? explicitRawLocales[0].code : 'fa';
    ...
    function buildDateEnv$1(settings) {
        var locale = buildLocale(settings.locale || 'fa', organizeRawLocales([]).map); // TODO: don't hardcode 'fa' everywhere
