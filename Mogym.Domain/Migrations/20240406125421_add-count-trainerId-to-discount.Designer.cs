...
namespace Mogym.Domain.Migrations
{
    ...
    [Migration("20240406125421_add-count-trainerId-to-discount")]
    partial class addcounttrainerIdtodiscount
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Mogym.Domain.Entities.Discount", b =>
                {
                    b.HasOne("Mogym.Domain.Entities.TrainerProfile", "TrainerProfile")
                        .WithMany("Discounts")
                        .HasForeignKey("TrainerId");
            ...
            modelBuilder.Entity("Mogym.Domain.Entities.Finance", b =>
                {
                    ...
                    b.HasOne("Mogym.Domain.Entities.Plan", "Plan_Finance")
                        .WithMany("Finances")
                        .HasForeignKey("PlanId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Discount_Finance");

                    b.Navigation("Plan_Finance");
                });
